...
typedef SearchMatchFn = bool Function(
    DropdownMenuItem item, String searchValue);
...
// The widgets that is the button wrapping the menu items.
              ...
              child: Column(
                ...
                children: [
                  ...
                  Flexible(
                      child: Padding(
                          padding:
                              widget.dropdownScrollPadding ?? EdgeInsets.zero,
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    return BoxConstraints(
        minWidth: width, maxWidth: width, maxHeight: maxHeight);
  }
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    ...
    switch (textDirection!) {
      case TextDirection.rtl:
        left = _clampDouble(buttonRect.right - childSize.width + offset.dx, 0.0,
...
// This widgets enables _DropdownRoute to look up the sizes of
...
// The container widgets for a menu item created by a [DropdownButton]. It
...
class _DropdownMenuItemContainer extends StatelessWidget {
  ...
  const _DropdownMenuItemContainer(
      {this.alignment = AlignmentDirectional.centerStart, required this.child});
...
///
/// One ancestor must be a [Material] widgets and typically this is
...
/// will display the [disabledHint] widgets if it is non-null. However, if
/// [disabledHint] is null and [hint] is non-null, the [hint] widgets will
...
/// See also:
///
///  * [DropdownButtonFormField2], which integrates with the [Form] widgets.
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  /// Uses custom widgets like icon,image,etc.. instead of the default button
  ...
  /// The widgets to use for searchable dropdowns, such as search bar.
  ...
  /// A placeholder widgets that is displayed by the dropdown button.
  ///
  /// If [value] is null and the dropdown is enabled ([items] and [onChanged] are non-null),
  /// this widgets is displayed as a placeholder for the dropdown button's value.
  ///
  /// If [value] is null and the dropdown is disabled and [disabledHint] is null,
  /// this widgets is used as the placeholder.
  final Widget? hint;

  /// A preferred placeholder widgets that is displayed when the dropdown is disabled.
  ///
  ...
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [DropdownButton2.disabledHint] widgets if it is non-null.
  ...
  ///
  /// When a [DropdownMenuItem] is selected, the widgets that will be displayed
  ...
  /// The widgets to use for drawing the drop-down button's underline.
  ///
  /// Defaults to a 0.0 width bottom border with color 0xFFBDBDBD.
  final Widget? underline;

  /// The widgets to use for the drop-down button's icon.
  ///
...
class DropdownButton2State<T> extends State<DropdownButton2<T>>
  ...
  Widget build(BuildContext context) {
    ...
    // We should explicitly type the items list to be a list of <widgets>,
...
///
/// This is a convenience widgets that wraps a [DropdownButton2] widgets in a
/// [FormField].
///
...
class DropdownButtonFormField2<T> extends FormField<T> {
  /// Creates a [DropdownButton2] widgets that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
      ...
      : assert(
        ...
        super(
          ...
          builder: (FormFieldState<T> field) {
            ...
            // An unFocusable Focus widgets so that this widgets can detect if its
